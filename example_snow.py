...
def main():
    ...
    compute_snow(path_ori, 'plate_10elements', 50,
                'hres_snow_lw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
                'lut_snow_lw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
                'pade_snow_lw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
    ...
    # generate parameterization for shortwave snow
    compute_snow(path_ori, 'plate_10elements', 50,
                'hres_snow_sw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
                'lut_snow_sw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
                'pade_snow_sw_plate_10elements_severlyroughen_gamma_aeq1_thick.nc',
                1, wavenum, source, band_limit, re_range_lut, re_range_pade,
                re_ref_pade,False)
