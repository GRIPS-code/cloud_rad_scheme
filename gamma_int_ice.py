def gamma_int_ice(habit,roughness,file_lut,file_pade,a,wavenum_out,source, band_limit,re_range_lut,re_range_pade,re_ref_pade,thin_flag):
    import numpy as np
    ...
    [wavenum_in, r_in, d_in, s_in, v_in, ext_cross_section_in, sca_cross_section_in, asy_in]=\
        read_yang_ice_library(habit,roughness)
